...
Auto-selection: if groundmemory_EMBEDDING_BASE_URL or OPENAI_API_KEY is set → openai;
...
class OpenAICompatibleProvider(EmbeddingProvider):
    ...
    def __init__(
        ...
        self._model = model
        self._base_url = (base_url or os.environ.get("groundmemory_EMBEDDING_BASE_URL")
                          or "https://api.openai.com/v1").rstrip("/")
        self._api_key = (api_key or os.environ.get("groundmemory_EMBEDDING_API_KEY")
